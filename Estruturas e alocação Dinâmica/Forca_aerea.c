...
if(n_reg==-1)
  ...
  {
  	atualiza_numreg(pc,n_reg);   //mostra e decrementa o numero de patentes atuais
    printf("\nEscolha a NOVA Organizacaoo: Exercito / Aeronautica / Marinha\n");
	gets(aux_org);
	fflush(stdin);
	maiuscula(aux_org);
	printf("\nDigite a patente: ");
